...
# dashscope.api_key = "sk-b336c00da0a84508a5e238341287efa6"
dashscope.api_key = "sk-28ae4f9d2ca444f59a683a38a29a3833"
...
if __name__ == "__main__":
    ...
    for i in range(len(support_set_class)):
        ...
        for j in range(len(test_set_sample[i])):
            ...
            text = "choose a category label from the following list for the image." + text1 + "Expected output: (only the category of the image)"
